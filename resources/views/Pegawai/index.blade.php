        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#modal-info{{ $item->id }}">
                                                    <i class="fas fa-pencil-alt">
                                                    </i> Edit
                                                </button>
                                                <form method="POST" action="{{ route('pegawai.destroy', $item->id) }}" class="d-inline">
                                                    @csrf @method('DELETE')
                                                ...
                                                {{-- <form method="POST" onsubmit="return confirm('Yakin mau hapus data ini?')" action="{{ route('pegawai.destroy', $item->id) }}" class="d-inline">
                                                    @csrf @method('DELETE')
                    ...
                    @include('Pegawai.create') @endsection
                </div>
            </div>
    </section>
</div>